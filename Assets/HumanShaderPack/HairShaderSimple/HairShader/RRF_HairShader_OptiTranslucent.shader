...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:3,spmd:0,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:True,hqlp:True,rprd:True,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:2,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:2,rntp:3,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:2865,x:34791,y:32733,varname:node_2865,prsc:2|diff-8051-OUT,spec-7877-OUT,gloss-7779-A,normal-208-OUT,emission-9260-OUT,clip-8370-R;n:type:ShaderForge.SFN_Tex2d,id:5242,x:31993,y:32702,ptovrint:False,ptlb:NormalMap1,ptin:_NormalMap1,varname:node_5242,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:8706,x:31993,y:32888,ptovrint:False,ptlb:NormalMap2,ptin:_NormalMap2,varname:node_8706,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,ntxv:3,isnm:True;n:type:ShaderForge.SFN_Tex2d,id:8370,x:31993,y:33088,ptovrint:False,ptlb:Cutout/TipGrad1/TipGrad2,ptin:_CutoutTipGrad1TipGrad2,varname:node_8370,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:db53956d7bc64a542926b4d2aa7b036b,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Color,id:7779,x:31993,y:32472,ptovrint:False,ptlb:Hair_Color/Gloss,ptin:_Hair_ColorGloss,varname:node_7779,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_Multiply,id:7877,x:33403,y:32666,varname:node_7877,prsc:2|A-8051-OUT,B-1087-OUT;n:type:ShaderForge.SFN_Slider,id:1087,x:31679,y:32645,ptovrint:False,ptlb:SpecColor Inheritance,ptin:_SpecColorInheritance,varname:node_1087,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-1,cur:0,max:5;n:type:ShaderForge.SFN_NormalBlend,id:6912,x:32242,y:32814,varname:node_6912,prsc:2|BSE-5242-RGB,DTL-8706-RGB;n:type:ShaderForge.SFN_Lerp,id:8201,x:32495,y:33018,varname:node_8201,prsc:2|A-7779-RGB,B-9661-OUT,T-4546-OUT;n:type:ShaderForge.SFN_Color,id:1983,x:31993,y:33267,ptovrint:False,ptlb:Grad1_Color,ptin:_Grad1_Color,varname:node_1983,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:9661,x:32350,y:33147,varname:node_9661,prsc:2|A-4546-OUT,B-1983-RGB;n:type:ShaderForge.SFN_Color,id:4505,x:31993,y:33443,ptovrint:False,ptlb:Grad2_Color,ptin:_Grad2_Color,varname:node_4505,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:0.5,c3:1,c4:1;n:type:ShaderForge.SFN_Multiply,id:9615,x:32439,y:33400,varname:node_9615,prsc:2|A-3215-OUT,B-4505-RGB;n:type:ShaderForge.SFN_Lerp,id:3241,x:32717,y:33097,varname:node_3241,prsc:2|A-8201-OUT,B-9615-OUT,T-3215-OUT;n:type:ShaderForge.SFN_Slider,id:878,x:31702,y:33394,ptovrint:False,ptlb:Grad2_Power,ptin:_Grad2_Power,varname:node_878,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.446602,max:1;n:type:ShaderForge.SFN_Multiply,id:3215,x:32210,y:33296,varname:node_3215,prsc:2|A-8370-B,B-878-OUT;n:type:ShaderForge.SFN_Slider,id:9632,x:31610,y:33114,ptovrint:False,ptlb:Grad1_Power,ptin:_Grad1_Power,varname:_Grad2_Power_copy,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_Multiply,id:4546,x:32171,y:33147,varname:node_4546,prsc:2|A-8370-G,B-9632-OUT;n:type:ShaderForge.SFN_Normalize,id:7103,x:33065,y:32767,varname:node_7103,prsc:2|IN-7485-OUT;n:type:ShaderForge.SFN_Vector3,id:6285,x:32489,y:32639,varname:node_6285,prsc:2,v1:0,v2:0,v3:0.5;n:type:ShaderForge.SFN_Lerp,id:7485,x:32664,y:32683,varname:node_7485,prsc:2|A-6285-OUT,B-6912-OUT,T-388-OUT;n:type:ShaderForge.SFN_Slider,id:388,x:32242,y:32735,ptovrint:False,ptlb:Normal_Blending,ptin:_Normal_Blending,varname:node_388,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.5,max:1;n:type:ShaderForge.SFN_NormalVector,id:2397,x:32141,y:32190,prsc:2,pt:False;n:type:ShaderForge.SFN_Multiply,id:1387,x:32853,y:32407,varname:node_1387,prsc:2|A-7991-OUT,B-1983-RGB,C-9632-OUT;n:type:ShaderForge.SFN_Add,id:8051,x:33144,y:32555,varname:node_8051,prsc:2|A-1387-OUT,B-3241-OUT;n:type:ShaderForge.SFN_NormalVector,id:3067,x:33093,y:32981,prsc:2,pt:False;n:type:ShaderForge.SFN_NormalBlend,id:208,x:33599,y:32808,varname:node_208,prsc:2|BSE-7103-OUT,DTL-2237-OUT;n:type:ShaderForge.SFN_Add,id:2237,x:33375,y:33016,varname:node_2237,prsc:2|A-3067-OUT,B-3418-RGB;n:type:ShaderForge.SFN_Color,id:3418,x:33110,y:33166,ptovrint:False,ptlb:Normal Angle Shift,ptin:_NormalAngleShift,varname:node_3418,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.5,c2:0.5,c3:0.5,c4:1;n:type:ShaderForge.SFN_OneMinus,id:5471,x:33865,y:32852,varname:node_5471,prsc:2|IN-7991-OUT;n:type:ShaderForge.SFN_Slider,id:5814,x:33751,y:33003,ptovrint:False,ptlb:Translucency,ptin:_Translucency,varname:node_5814,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Multiply,id:3762,x:34130,y:32889,varname:node_3762,prsc:2|A-5471-OUT,B-5814-OUT;n:type:ShaderForge.SFN_Fresnel,id:2494,x:34119,y:33080,varname:node_2494,prsc:2|NRM-9965-OUT,EXP-9863-OUT;n:type:ShaderForge.SFN_Multiply,id:4628,x:34330,y:32836,varname:node_4628,prsc:2|A-3762-OUT,B-2494-OUT;n:type:ShaderForge.SFN_Vector1,id:9863,x:33893,y:33114,varname:node_9863,prsc:2,v1:1;n:type:ShaderForge.SFN_Normalize,id:9965,x:33717,y:33093,varname:node_9965,prsc:2|IN-208-OUT;n:type:ShaderForge.SFN_Clamp01,id:9260,x:34502,y:32873,varname:node_9260,prsc:2|IN-4628-OUT;n:type:ShaderForge.SFN_LightVector,id:3211,x:32141,y:31984,varname:node_3211,prsc:2;n:type:ShaderForge.SFN_Dot,id:7991,x:32374,y:32072,varname:node_7991,prsc:2,dt:0|A-3211-OUT,B-2397-OUT;proporder:7779-1087-8370-5242-8706-1983-9632-4505-878-388-3418-5814;pass:END;sub:END;*/

Shader "RRF_HumanShaders/HairShader1/RRF_HairShader_OptiTranslucent" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 node_208_nrm_detail = (i.normalDir+_NormalAngleShift.rgb) * float3(-1,-1,1);
...
////// Specular:
                ...
                float node_7991 = dot(lightDirection,i.normalDir);
                float node_4546 = (_CutoutTipGrad1TipGrad2_var.g*_Grad1_Power);
                float node_3215 = (_CutoutTipGrad1TipGrad2_var.b*_Grad2_Power);
                float3 node_8051 = ((node_7991*_Grad1_Color.rgb*_Grad1_Power)+lerp(lerp(_Hair_ColorGloss.rgb,(node_4546*_Grad1_Color.rgb),node_4546),(node_3215*_Grad2_Color.rgb),node_3215));
...
////// Emissive:
                float node_9260 = saturate((((1.0 - node_7991)*_Translucency)*pow(1.0-max(0,dot(normalize(node_208), viewDirection)),1.0)));
                float3 emissive = float3(node_9260,node_9260,node_9260);
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float3 node_208 = node_208_nrm_combined;
                float node_9260 = saturate((((1.0 - node_7991)*_Translucency)*pow(1.0-max(0,dot(normalize(node_208), viewDirection)),1.0)));
                o.Emission = float3(node_9260,node_9260,node_9260);
